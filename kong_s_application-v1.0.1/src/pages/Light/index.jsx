  ...
  return (
    <>
      <div className="bg-gray-100 border border-black-900 border-solid flex flex-col font-inter items-center justify-start mx-auto w-full">
        ...
        <div className="bg-gradient1  flex sm:flex-col flex-row sm:gap-10 items-center justify-between max-w-[1434px] mb-0.5 mx-auto p-[39px] md:px-5 w-full">
          <Text
            className="ml-12 sm:ml-[0] sm:text-[31px] md:text-[33px] text-[35px] text-blue_gray-900 tracking-[-0.18px]"
            size="txtInterSemiBold35"
          >
            1화
          </Text>
          <Text
            className="leading-[50.00px] sm:mt-0 mt-[15px] text-2xl md:text-[22px] text-blue_gray-900 sm:text-xl tracking-[-0.12px]"
          ...
          >
            <span className="text-blue_gray-900 font-inter text-left font-semibold">
              ...
              자신들에게 맹독성 독을 감염시킬 수 있다는 것이다. 그래서 괴물들은
              어린이와 접촉해서
            </span>
          ...
          <Text
            className="text-2xl md:text-[22px] text-blue_gray-900 sm:text-xl tracking-[-0.12px]"
            size="txtInterSemiBold24Bluegray900"
          >
            60분
          </Text>
