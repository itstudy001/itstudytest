...
const SignupPageDarkPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-800_01 border border-black-900 border-solid flex flex-col font-inter sm:gap-10 md:gap-10 gap-[82px] justify-start mx-auto pb-[173px] w-full">
        <div className="flex flex-col items-center w-full">
          ...
          <Text
            className="leading-[50.00px] mt-[135px] text-4xl sm:text-[32px] md:text-[34px] text-center text-white-A700 tracking-[-0.18px]"
            size="txtInterSemiBold36WhiteA700"
          >
            <span className="text-white-A700 font-inter font-semibold">
              안녕하세요,{" "}
            </span>
            <span className="text-red-200 font-inter font-semibold">
              65941000
            </span>
            <span className="text-white-A700 font-inter font-semibold">
              <>
        ...
        <div className="flex flex-col items-end md:px-10 sm:px-5 px-[239px] w-full">
          <Button
            className="common-pointer cursor-pointer font-semibold min-w-[124px] md:text-3xl sm:text-[28px] text-[32px] text-center tracking-[-0.16px]"
...
export default SignupPageDarkPage;
